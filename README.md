...
## Keyword bank import (Forsati overlay)
To load the Jordan Arabic/English keyword banks into the peeljobs-core database, run from within the Django service directory:
```bash
cd apps/peeljobs-core
...
```
See `docs/KEYWORDS_PIPELINE.md` for the full pipeline and API details.
